...
<div className="sb-container">
    <div className='sb-section-title'>
        ...
        - Bequeme Helfer: addBlnInput, addBlnTextarea, addBlnTabs, addBlnCalendar, addBlnModalDialog, addBlnTree, addBlnCheckbox, addModernTree, addBlnToast, addBlnSelect, addBlnButton
...
`}
    ...
    `}
        ...
        - addBlnModalDialog(props?: Partial von BlnModalProps): this
        - Fügt ein BlnModalDialog-Element ein; alle BlnModalDialog-Properties können gesetzt werden (z. B. title, text, inputLabel, 
        inputPlaceholder, inputValue, inputType, showInput, buttons, size, closeOnBackdrop, closeOnEscape, ariaLabel, validator usw.).
